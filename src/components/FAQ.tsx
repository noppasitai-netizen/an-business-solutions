...
export default function FAQ() {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      question: "ใช้ระบบอัตโนมัติแล้วข้อมูลจะถูกต้องทั้งหมดไหม",
      answer: "AI ไม่แทนนักบัญชี ทีมตรวจทานก่อนยื่นทุกครั้ง ระบบอัตโนมัติของเราทำหน้าที่ช่วยสแกนบิลเบื้องต้น จัดเรียงหมวดหมู่ ตรวจเลข 13 หลัก และตรวจสอบรายการเอกสารขาดหาย (Checklist) เพื่อช่วยให้คุณทำงานร่วมกับเราได้เร็วขึ้น ส่วนการจัดทำและตรวจทานข้อมูลจริง การบันทึกบัญชี และการยื่นแบบภาษีทั้งหมดจะได้รับการดูแลและตรวจทานโดยนักบัญชีหรือผู้ทำบัญชีของ A&N Business Solutions ทุกขั้นตอนก่อนนำส่ง"
    },
    {
