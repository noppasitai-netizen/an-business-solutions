      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16 flex flex-col gap-4">
          ...
          <p className="text-slate-400 text-sm sm:text-base">
            AI ไม่แทนนักบัญชี ทีมตรวจทานก่อนยื่นทุกครั้ง ระบบนี้ช่วยคัดกรองและจัดลำดับงานเอกสารเบื้องต้น โดยมีนักบัญชีมืออาชีพคอยควบคุมและตรวจทานอย่างละเอียดก่อนยื่นสรรพากรและกระทรวงพาณิชย์ทุกครั้ง
          </p>
        </div>
